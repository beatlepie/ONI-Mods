...
{
    /// <summary>
    /// Class for patching [CreateDuplicantNavigation], it adds [CreateReapyNavigation] at the end of it
    ...
    {
        // The value is assigned at the end of [CreateReapyNavigation]
        public static NavGrid ReapyGrid;

        /// <summary>
        /// Adds [CreateReapyNavigation] at the end of [CreateDuplicantNavigation]
        /// </summary>
        ...
        private static void Postfix(Pathfinding pathfinding)
        {
            ...
            CreateReapyNavigation(pathfinding, "ReapyNavGrid", new CellOffset[] { new CellOffset(0, 0) });
        }

        /// <summary>
        /// Initializes the [ReapyNavGrid]
        /// </summary>
        /// <param name="pathfinding"> The [pathfinding] instance that saves all the [NavGrid]s </param>
        ...
        private static void CreateReapyNavigation(Pathfinding pathfinding, string id, CellOffset[] bounding_offsets)
        {
            ...
            NavGrid.Transition[] transitions = new NavGrid.Transition[]
            {
                ...
                new NavGrid.Transition(NavType.Floor, NavType.Floor, 1, 0, NavAxis.NA, true, true, true, 1, "floor_floor_1_0", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0], false, 1f),
                // Jump forward, over a single tile gap
                new NavGrid.Transition(NavType.Floor, NavType.Floor, 2, 0, NavAxis.NA, true, true, true, 2, "floor_floor_1_0", new CellOffset[]
                {
                ...
                new NavGrid.Transition(NavType.Floor, NavType.Ladder, 2, 0, NavAxis.NA, true, true, true, 2, "floor_floor_1_0", new CellOffset[]
                {
                ...
                new NavGrid.Transition(NavType.Ladder, NavType.Ladder, 2, 0, NavAxis.NA, true, true, true, 2, "floor_floor_1_0", new CellOffset[]
                {
                    // The cell in front must be free
                    new CellOffset(1, 0),
                    // The cell below the next cell must be free
                ...
                new NavGrid.Transition(NavType.Ladder, NavType.Floor, 1, 0, NavAxis.NA, true, true, true, 1, "floor_floor_1_0", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0], false, 1f),
                // Jump forward to a floor from a ladder
                new NavGrid.Transition(NavType.Ladder, NavType.Floor, 2, 0, NavAxis.NA, true, true, true, 2, "floor_floor_1_0", new CellOffset[]
                {
                    // The cell in front must be free
                    new CellOffset(1, 0),
                    // The cell below the next cell must be free
                ...
                new NavGrid.Transition(NavType.Floor, NavType.Pole, 2, 0, NavAxis.NA, true, true, true, 2, "floor_floor_1_0", new CellOffset[]
                {
                    // The cell in front must be free
                    new CellOffset(1, 0),
                    // The cell below the next cell must be free
                ...
                // Jump forward to a pole
                new NavGrid.Transition(NavType.Pole, NavType.Pole, 2, 0, NavAxis.NA, true, true, true, 2, "floor_floor_1_0", new CellOffset[]
                {
                    // The cell in front must be free
                    new CellOffset(1, 0),
                    // The cell below the next cell must be free
                ...
                new NavGrid.Transition(NavType.Pole, NavType.Floor, 1, 0, NavAxis.NA, true, true, true, 1, "floor_floor_1_0", new CellOffset[0], new CellOffset[0], new NavOffset[0], new NavOffset[0], false, 1f),
                // Jump forward to a floor from a pole
                new NavGrid.Transition(NavType.Pole, NavType.Floor, 2, 0, NavAxis.NA, true, true, true, 2, "floor_floor_1_0", new CellOffset[]
                {
                    // The cell in front must be free
                    new CellOffset(1, 0),
                    // The cell below the next cell must be free
                ...
                new NavGrid.Transition(NavType.Ladder, NavType.Pole, 2, 0, NavAxis.NA, true, true, true, 2, "floor_floor_1_0", new CellOffset[]
                {
                    // The cell in front must be free
                    new CellOffset(1, 0),
                    // The cell below the next cell must be free
                ...
                new NavGrid.Transition(NavType.Pole, NavType.Ladder, 2, 0, NavAxis.NA, true, true, true, 2, "floor_floor_1_0", new CellOffset[]
                {
                    // The cell in front must be free
                    new CellOffset(1, 0),
                    // The cell below the next cell must be free
            ...
            ReapyGrid = new NavGrid(id, completeTransition, nav_type_data, bounding_offsets, new NavTableValidator[]
            {
                new GameNavGrids.FloorValidator(true),
                new GameNavGrids.LadderValidator(),
                new GameNavGrids.PoleValidator(),
                // FOR SOME REASON THIS IS NECESSARY!!!!!
                // This allows reapy to walk on pitcher pumps, not exactly sure why...even though [FloorValidator] is supposed to allow it too...right?
                new GameNavGrids.HoverValidator()
            }, 2, 0, completeTransition.Length);
            pathfinding.AddNavGrid(ReapyGrid);
        }
        ...
        private static NavOffset[] MirrorNavOffsets(NavOffset[] offsets)
        {
            ...
            {
                reversed = navOffset;
                // Below code is unnecessary for this specific case, as reapy cannot climb walls.
