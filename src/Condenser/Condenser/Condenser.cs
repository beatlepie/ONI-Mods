...
namespace Condenser
{
    public class Condenser : StateMachineComponent<Condenser.StatesInstance>
    {
        ...
        private void cool(Condenser.StatesInstance smi, float dt)
        {
            //If there is more than 1 
            float num = this.coolRate * dt / (float)this.inputStorage.items.Count;
        ...
        public class States : GameStateMachine<States, StatesInstance, Condenser>
        {
            ...
            public override void InitializeStates(out StateMachine.BaseState default_state)
            {
                ...
                //.Enter(delegate (Condenser.StatesInstance smi) { Debug.Log(smi.master.operational); })
                ...
                working
                    ...
                    .Update(delegate (Condenser.StatesInstance smi, float dt) { smi.master.cool(smi, dt); smi.changeStorage(); })
