...
namespace Vaporiser
{
    public class VaporizerConfig : IBuildingConfig
    {
        ...
        {
            AddBuilding.AddStrings("Vaporizer", "Vaporizer", "Allows liquid contents to vaporize! It starts operating of 30kg of liquid, and heats until 20 degrees over the boiling point. It heats itself by 16kDTU while it is active.", "Allows liquid to vaporize.");
